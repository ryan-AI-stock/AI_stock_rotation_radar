...
TASK = "TASK-RADAR-DATA-VNEXT-P1-P2-OLD-AI7-PRIORITY-00631L-BACKUP-CD-OVERRIDE-EXACT-CLOSE-FILL-001"
...
OUTPUT = REPO / "outputs/radar_vnext_p1_p2_old_ai7_priority_00631l_backup_cd_override_close_fill_20260720"
TARGETS = {"2016-12-01", "2024-09-16"}
REUSE = {
    "2016-12": REPO / "outputs/radar_vnext_p1_p2_sleeve_internal_timing_close_fill_20260718/checkpoints/00631L/2016-12.json.gz",
    "2024-09": REPO / "outputs/radar_vnext_p1_p2_sleeve_internal_timing_close_fill_20260718/checkpoints/00631L/2024-09.json.gz",
}
...
def run(args: argparse.Namespace) -> dict:
    ...
    prefix = "old_ai7_priority_backup_cd_override_exact_close"
    ...
    atomic_json(output / "readiness_for_core_old_ai7_priority_backup_cd_override_close_absorption.json", readiness)
