...
from .day_trading import build_day_trading_dataset


def main() -> None:
    parser = argparse.ArgumentParser(description="Build TWSE day-trading data for the 9-asset overlay pool.")
    parser.add_argument(
        "--output",
        default="data/formal_sources/chip_flow_overlay_2021_2023/day_trading_daily_2021_2023.csv",
    )
    parser.add_argument(
        "--gap-report",
        default="data/formal_sources/chip_flow_overlay_2021_2023/day_trading_daily_2021_2023_gap.csv",
    )
    parser.add_argument(
        "--readiness-output",
        default="data/formal_sources/chip_flow_overlay_2021_2023/day_trading_daily_2021_2023_readiness.json",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--raw-day-trading-cache-dir",
        default="data/formal_sources/chip_flow_overlay_2021_2023/raw_twse_day_trading_cache",
    )
    parser.add_argument(
        "--raw-volume-cache-dir",
        default="data/formal_sources/chip_flow_overlay_2021_2023/raw_twse_stock_day_volume_cache",
    )
    ...
    result = build_day_trading_dataset(
        ...
        raw_day_trading_cache_dir=args.raw_day_trading_cache_dir,
        raw_volume_cache_dir=args.raw_volume_cache_dir,
