...
from .day_trading import validate_day_trading_dataset


def main() -> None:
    parser = argparse.ArgumentParser(description="Validate TWSE day-trading data for the 9-asset overlay pool.")
    parser.add_argument(
        "--input",
