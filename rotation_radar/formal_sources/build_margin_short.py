...
from .margin_short import build_margin_short_dataset


def main() -> None:
    parser = argparse.ArgumentParser(description="Build TWSE MI_MARGN margin/short data for the 9-asset overlay pool.")
    parser.add_argument(
        "--output",
    ...
    parser.add_argument(
        "--raw-cache-dir",
        default="data/formal_sources/chip_flow_overlay_2021_2023/raw_twse_margin_cache",
    )
