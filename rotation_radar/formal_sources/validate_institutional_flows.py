...
from .institutional_flows import validate_institutional_flows_dataset


def main() -> None:
    parser = argparse.ArgumentParser(description="Validate TWSE T86 institutional flows for the 9-asset overlay pool.")
    parser.add_argument(
        "--input",
