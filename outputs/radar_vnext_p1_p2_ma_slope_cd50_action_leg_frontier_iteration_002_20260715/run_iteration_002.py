...
runner.TASK_ID = "TASK-RADAR-DATA-VNEXT-P1-P2-MA-SLOPE-CD50-ACTION-LEG-FRONTIER-ITERATION-002"
runner.EXPECTED_FRONTIER_ROWS = 42
runner.EXPECTED_REQUEST_SPANS = 56
runner.EXPECTED_POLICY_ROWS = 35
runner.EXPECTED_UNCLASSIFIED_ROWS = 14946
runner.PROVISIONAL_GAP_ROWS = 8846
