...
- 下載 authority 僅限 Core 指定 94 筆 frontier exact legs。
- exact official raw ready：94/94；official no-trade：0/94；true source blocked：0/94。
- local official raw reuse：34 筆；bounded official route patch：60 筆。
- incumbent continuity 共 25,266 筆僅做 local A/B/C/D/E 分類，網路下載 0 筆。
- 39 筆 atomic policy blockers 與 9,686 provisional gaps 均未作下載清單。
