...
TASK_ID = "TASK-RADAR-DATA-VNEXT-WEEKLY-R6-SINGLE-POSITION-RECONSTRUCTED-P2-SELECTED-STOCK-DAILY-OHLC-GAP-FILL-001"
RADAR_ROOT = Path(r"C:\Users\zergv\Documents\Codex\2026-05-23\ai-stock-rotation-radar-https-docs")
BASE = RADAR_ROOT / "outputs" / "radar_vnext_weekly_r6_single_position_reconstructed_p2_selected_stock_daily_ohlc_gap_fill_20260710"
RAW = BASE / "raw_sources"
CORE_LEDGER = Path(
    r"C:\Users\zergv\Documents\Codex\2026-05-30\ep05-chat-ai-stock-backtest-lab"
    r"\outputs\vnext_weekly_r6_single_position_state_boundary_reconstruction_contract_20260710"
    r"\reconstructed_weekly_r6_selected_stock_daily_ohlc_gap_ledger.csv"
)
...
def main() -> None:
    ...
    prefix = "reconstructed_weekly_r6_p2_selected_stock_daily"
    ...
    coverage = [{
        ...
        "adjusted_close_ready": False,
        "ready_for_core_reconstructed_weekly_r6_p2_daily_ohlc_absorption": ready,
        "future_data_violation_count": 0,
    }]
    write_csv(BASE / f"{prefix}_ohlc_coverage_audit.csv", coverage, [
        ...
        "ready_for_core_reconstructed_weekly_r6_p2_daily_ohlc_absorption", "future_data_violation_count",
    ])
    ...
    readiness = {
        "task_id": TASK_ID,
        "status": "completed_reconstructed_weekly_r6_p2_daily_ohlc_source_package_ready_for_core_absorption" if ready else "partial_reconstructed_weekly_r6_p2_daily_ohlc_source_package_blocked_rows_remain",
        "input_gap_rows": len(ledger),
        "filled_rows": len(filled),
        "blocked_rows": len(blocked),
        "unique_tickers": len({norm_ticker(row.get("ticker", "")) for row in ledger}),
    ...
    (BASE / "readiness_for_core_reconstructed_weekly_r6_p2_daily_ohlc_absorption.json").write_text(json.dumps(readiness, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    ...
    artifacts = [
        ...
        "readiness_for_core_reconstructed_weekly_r6_p2_daily_ohlc_absorption.json",
        "manifest.json",
        "final_summary_zh.md",
        "current_step.txt",
    ]
    ...
    (BASE / "final_summary_zh.md").write_text(f"""# Reconstructed weekly R6 P2 selected-stock daily OHLC gap fill
...
- adjusted_close_ready=false
- ready_for_core_reconstructed_weekly_r6_p2_daily_ohlc_absorption={str(ready).lower()}
- ready_for_experiments=false
- ready_for_formal=false
- future_data_violation_count=0
