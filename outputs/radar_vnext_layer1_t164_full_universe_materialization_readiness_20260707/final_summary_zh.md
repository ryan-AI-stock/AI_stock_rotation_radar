# vNext Layer1 t164 full-universe / broader materialization readiness

Status: larger_universe_materialization_readiness_blocked_by_asof_match_gaps

結論：
- 這是 larger bounded materialization readiness，不是 full ingest，不交 Experiments。
- payload replay 已實際擴到 20 檔、2 個市場、2 個期間；115Q1、114Q4。
- t164sb05/t164sb03 statement sample success rows: 40/40。
- t05st01 official announcement timestamp matched rows: 34/40。
- unmatched / ambiguous announcement rows: 6。
