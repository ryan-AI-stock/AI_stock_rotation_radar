...
readiness = {
    "task_id": "TASK-RADAR-DATA-VNEXT-LAYER1-T164-BROADER-SOURCE-MATERIALIZATION-READINESS-001",
    ...
    "coverage": "bounded sample: 4 tickers, TWSE/TPEx, 2 periods, t164 cashflow/balance sheet plus t05st01 announcement timestamp match",
    ...
    "ready_for_core_t164_broader_interim_official_asof_join": matched_rows == total_rows and t164_success_rows == total_rows,
    ...
    "future_data_violation_count": 0,
    "not_live_rule": True,
    "blocked_reason": "bounded broader sample is ready for Core interim official-asof join design, but full ingest still needs universe runner, full coverage audit, TPEx universal confirmation, and label policy approval",
    **FLAGS,
}
...
manifest = {
    ...
    "forward_returns_live_rule_usage": False,
    "files": [
        "radar_t164_broader_source_materialization_matrix.csv",
        "radar_t164_t05st01_match_candidate_coverage.csv",
        "radar_t164_twse_tpex_route_coverage.csv",
        "radar_t164_field_label_review_ledger.csv",
        "radar_t164_asof_policy_audit.csv",
        "radar_t164_blocked_prohibited_ledger.csv",
        "readiness_for_core_t164_broader_source_materialization.json",
        "final_summary_zh.md",
        "manifest.json",
    ],
}

write_csv("radar_t164_broader_source_materialization_matrix.csv", materialization_rows)
write_csv("radar_t164_t05st01_match_candidate_coverage.csv", coverage_rows)
write_csv("radar_t164_twse_tpex_route_coverage.csv", route_rows)
write_csv("radar_t164_field_label_review_ledger.csv", label_rows)
write_csv("radar_t164_asof_policy_audit.csv", asof_rows)
write_csv("radar_t164_blocked_prohibited_ledger.csv", blocked_rows)
write_json("readiness_for_core_t164_broader_source_materialization.json", readiness)
write_json("manifest.json", manifest)

summary = f"""# vNext Layer1 t164 broader source materialization readiness
