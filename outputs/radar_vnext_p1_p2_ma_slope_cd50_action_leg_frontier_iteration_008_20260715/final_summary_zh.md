...
- 下載 authority 僅限 Core 指定 88 筆 frontier exact legs。
- exact official raw ready：88/88；official no-trade：0/88；true source blocked：0/88。
- local official raw reuse：48 筆；bounded official route patch：40 筆。
- incumbent continuity 共 25,505 筆僅做 local A/B/C/D/E 分類，網路下載 0 筆。
- 42 筆 atomic policy blockers 與 8,865 provisional gaps 均未作下載清單。
