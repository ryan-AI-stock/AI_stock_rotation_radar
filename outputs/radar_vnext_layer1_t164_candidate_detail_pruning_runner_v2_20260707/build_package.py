...
CORE_REVIEW = Path(r"C:\Users\zergv\Documents\Codex\2026-05-30\ep05-chat-ai-stock-backtest-lab\outputs\vnext_layer1_t164_broader_source_package_review_20260707")
...
total_rows = len(TICKERS) * len(PERIODS)
...
projected_rows = [{
    ...
    "budget_status": "pass" if projected_total_routes / total_rows <= MAX_PROJECTED_ROUTES_PER_ROW else "blocked_over_budget",
    **FLAGS,
}]

if projected_rows[0]["budget_status"] != "pass":
    write_csv("projected_route_cost_report.csv", projected_rows)
    write_json("readiness_for_core_t164_candidate_detail_pruning_runner_v2.json", {
        "task_id": "TASK-RADAR-DATA-VNEXT-LAYER1-T164-CANDIDATE-DETAIL-PRUNING-RUNNER-V2-001",
        "status": "blocked_by_projected_route_budget",
        "ready_for_core_t164_pruned_source_package_review": False,
...
tpex_readiness = [{
    ...
    "reason": "TPEx bounded seed passes pruning v2, but all-stock TPEx proof not executed",
    **FLAGS,
}]
...
readiness = {
    ...
    "coverage": "20 tickers x 2 periods pruning-v2 seed; TWSE/TPEx; not full universe",
    ...
    "budget_routes_per_row": MAX_PROJECTED_ROUTES_PER_ROW,
    "ready_for_core_t164_pruned_source_package_review": statement_success_rows == total_rows and asof_matched_rows == total_rows and route_error_count == 0,
    ...
    "future_data_violation_count": 0,
    "not_live_rule": True,
    "blocked_reason": "pruning v2 passes bounded seed but full ticker universe, full period range, TPEx all-stock proof, and label policy are still incomplete",
    **FLAGS,
}
...
manifest = {
    ...
    "ready_for_strategy_replay": False,
    "ready_for_core_t164_pruned_source_package_review": readiness["ready_for_core_t164_pruned_source_package_review"],
    "ready_for_experiments": False,
    "ready_for_formal": False,
    **FLAGS,
    "files": [
        ...
        "layer1_t164_candidate_detail_pruning_requirements.csv",
        "layer1_t164_radar_pruning_runner_v2_handoff.csv",
        "readiness_for_core_t164_candidate_detail_pruning_runner_v2.json",
        "manifest.json",
        "final_summary_zh.md",
    ],
}
...
write_json("readiness_for_core_t164_candidate_detail_pruning_runner_v2.json", readiness)
write_json("manifest.json", manifest)

summary = f"""# Layer1 t164 candidate/detail pruning runner v2
...
Readiness:
- ready_for_core_t164_pruned_source_package_review={str(readiness['ready_for_core_t164_pruned_source_package_review']).lower()}
- ready_for_core_t164_broader_ingest_contract=false
- ready_for_core_t164_broader_materialization=false
- ready_for_experiments=false
- ready_for_formal=false
